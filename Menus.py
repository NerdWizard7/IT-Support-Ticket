...
class ReportGenerator(wx.MiniFrame):
    def __init__(self, parent, title, pos=wx.DefaultPosition, size=wx.DefaultSize, style=wx.DEFAULT_FRAME_STYLE):
        ...
        sizer.Add(label0)
        label1 = wx.StaticText(panel, -1, 'Start')
        ...
        label1 = wx.StaticText(panel, -1, 'Numerical Report')
        self.RadioButton0 = wx.RadioButton(panel, -1)
        sizer.AddSpacer(20)
        sizer.Add(self.RadioButton0)
        label2 = wx.StaticText(panel, -1, 'Full Report')
        self.RadioButton1 = wx.RadioButton(panel, -1)
        sizer.AddSpacer(20)
        sizer.Add(self.RadioButton1)
        sizer.AddStretchSpacer()
        label1 = wx.StaticText(panel, -1, 'Completed Tickets')
        self.CheckBox0 = wx.CheckBox(panel, -1)
        sizer.AddSpacer(20)
        sizer.Add(self.CheckBox0)
        sizer.AddStretchSpacer()
        label1 = wx.StaticText(panel, -1, 'Submitted Tickets')
        self.CheckBox1 = wx.CheckBox(panel, -1)
        sizer.AddSpacer(20)
        sizer.Add(self.CheckBox1)
        sizer.AddStretchSpacer()
        label1 = wx.StaticText(panel, -1, 'Ticket Length')
        self.CheckBox2 = wx.CheckBox(panel, -1)
        sizer.AddSpacer(20)
        sizer.Add(self.CheckBox2)
        sizer.AddStretchSpacer()
        label1 = wx.StaticText(panel, -1, 'Graph')
        self.CheckBox3 = wx.CheckBox(panel, -1)
        sizer.AddSpacer(20)
        sizer.Add(self.CheckBox3)
        sizer.AddStretchSpacer()
